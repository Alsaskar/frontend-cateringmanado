...
class UangLunas extends StatefulWidget {
  ...
  @override
  State<UangLunas> createState() => _UangLunasState();
}

class _UangLunasState extends State<UangLunas> {
  ...
  Future<void> _sendBuktiTf() async {
    Future.delayed(Duration(seconds: 2), () async {
      if (_validateImage() != null) {
        ...
        var res = await PayService().payStepThree(
  ...
  Future<void> _cekStatus() async {
    ...
    setState(() {
      double hitung = widget.grandTotal * 0.20; // 20%
      _totalPembayaran = hitung;
      _buktiTf = res['stepThree'];
    });
            ...
            _buktiTf > 0
                ? Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text(
                          "Anda telah mengirimkan Bukti Transfer Uang Lunas",
                ...
                : Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Silahkan melakukan pembayaran uang lunas dengan total pembayaran dan dikirimkan ke Rekening yg tertera diatas",
                          style: TextStyle(
                            fontSize: 15,
                          ),
                        ),
