...
class UangTengah extends StatefulWidget {
  ...
  @override
  State<UangTengah> createState() => _UangTengahState();
}

class _UangTengahState extends State<UangTengah> {
  ...
  Future<void> _sendBuktiTf() async {
    Future.delayed(Duration(seconds: 2), () async {
      if (_validateImage() != null) {
        ...
        var res = await PayService().payStepTwo(
            widget.idItemMaster, _totalPembayaran.toString(), _photo!);
  ...
  Future<void> _cekStatus() async {
    ...
    setState(() {
      double hitung = widget.grandTotal * 0.30; // 30%
      _totalPembayaran = hitung;
      _buktiTf = res['stepTwo'];
    });
  }
            ...
            _buktiTf > 0
                ? Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text(
                          "Anda telah mengirimkan Bukti Transfer Uang Tengah",
                        ...
                        Text(
                          "Silahkan menunggu sampai Status Order diubah oleh Admin Toko, baru Anda melakukan Pembayaran tahap 3 yaitu Uang Lunas",
                          textAlign: TextAlign.center,
                        )
                      ],
                    ),
                ...
                : Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Silahkan melakukan pembayaran uang tengah dengan total pembayaran dan dikirimkan ke Rekening yg tertera diatas",
                          style: TextStyle(
                            fontSize: 15,
                          ),
                        ),
